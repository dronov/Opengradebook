...
ActiveRecord::Schema.define(:version => 20150920021200) do
  ...
  add_index "batches", ["is_deleted", "is_active", "course_id", "name"], :name => "index_batches_on_is_deleted_and_is_active_and_course_id_and_name", :limit => {"name"=>nil, "is_active"=>nil, "is_deleted"=>nil, "course_id"=>nil}

  create_table "biweekly_personality_grades", :force => true do |t|
    t.integer  "student_id"
  ...
  create_table "biweekly_subject_grades", :force => true do |t|
    t.integer  "student_id"
    t.integer  "subject_id"
    t.integer  "w1"
    t.integer  "w2"
  ...
  create_table "notas", :force => true do |t|
    ...
    t.datetime "updated_at"
    t.integer  "batch_id"
    t.integer  "recuperacion_1"
    t.integer  "recuperacion_2"
    t.integer  "recuperacion_3"
    t.integer  "recuperacion_4"
    t.integer  "recovery"
    t.integer  "recovery2"
  end
  ...
  create_table "school_reports", :force => true do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  add_index "schools", ["id"], :name => "index_schools_on_id", :limit => {"id"=>nil}
  ...
  create_table "student_additional_grade_field_details", :force => true do |t|
    t.integer  "student_id"
    t.integer  "batch_id"
    t.integer  "student_additional_grade_field_id"
    t.integer  "period"
  ...
  create_table "student_additional_grade_fields", :force => true do |t|
    t.string   "name"
    t.integer  "school_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "student_general_details", :force => true do |t|
    t.integer  "student_id"
    t.integer  "batch_id"
    t.integer  "period"
  ...
  create_table "student_grade_personalities", :force => true do |t|
    t.integer  "student_additional_grade_field_id"
    t.integer  "student_id"
    t.string   "p1"
    t.string   "p2"
